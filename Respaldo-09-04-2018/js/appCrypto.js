...
appCrypto.config( ['$routeProvider', '$locationProvider', function($routeProvider,$locationProvider){
...
appCrypto.constant( 'configuracionGlobal', {
	...
	'api_url': 'https://athenacryptobank.com/',
	...
	'lang': {
			'es': {
				...
				'service': [
					'INVERTIR',
					'​<br> <br> INVIERTE CON ATHENA CRYPTO BANK Y RECIBE CADA MES UNA GANANCIA DE HASTA EL 10% EN RELACIÓN CON TU INVERSIÓN, MODALIDAD SEGURA PARA INVERTIR EN LA CRIPTOMONEDA Y SIN PREOCUPACIONES POR LA OSCILACIÓN DE SU VALOR.<br><br>',
					'SERVICIO DE BANCO',
					...
					'COMPRAVENTA',
					'​​<br> <br> <br> CON ATHENA CRYPTO BANK LA COMPRA Y VENTA DE CRIPTOMONEDAS NUNCA HA SIDO TAN FÁCIL, BASTA CONSULTAR A TRAVÉS DE TELEGRAM A NUESTROS ASESORES EL MEJOR PRECIO DEL MOMENTO CON LOS DIFERENTES MÉTODOS DE PAGO.',
					'SERVICIOS',
					...
					"Ejemplo: Inversión de 100 euros trámite transferencia bancaria recibida el 15 marzo 2018 – Enviaremos una transferencia de 110 euros el 14 de abril 2018. ",
					"Términos y condiciones de uso:",
			...
			'en': {
				...
				'service': [
						...
						'TRADING',
						'<br> WITH ATHENA CRYPTO BANK THE PURCHASE AND SALE OF CRIPTOMONEDAS HAS NEVER BEEN SO EASY, IT IS ENOUGH TO CONSULT THROUGH TELEGRAM TO OUR ADVISORS THE BEST PRICE OF THE MOMENT WITH THE DIFFERENT METHODS OF PAYMENT.',
						"SERVICES",
						...
						"Example: Investment of 100 euros through bank transfer received on March 15, 2018 - We will send a transfer of 110 euros on April 14, 2018.",
						"Terms and conditions of use:",
			...
			'it': {
				...
				'service': [
						...
						'COMPRAVENDITA',
						"<br> <br> CON ATHENA CRYPTO BANK COMPRARE E VENDERE NON E' MAI STATO COSI FACILE, BASTA CHIEDERE TRAMITE TELEGRAM AI NOSTRI CONSULENTI IL MIGLIOR PREZZO AL MOMENTO PER DIVERSE MODALITA DI PAGAMENTO. <br> ",
						"SERVIZI",
						...
						"Esempio: Investimento di 100 euro tramite bonifico bancario ricevuto il 15 marzo 2018- Invieremo bonifico di 110 euro il 14 aprile 2018. ",
						"Condizioni e Termini di Utilizzo:",
						"Monete depositabili:",
						"-BTC - ​BCH - BTG - DASH - DOGE - ETH - ETC - LTC - NEO - XST - XRP - XLM  - ZEC - XVG - BCN",
